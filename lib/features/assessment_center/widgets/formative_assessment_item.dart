...
class FormativeAssessmentItem extends StatelessWidget {
  final FormativeAssessment item;
  const FormativeAssessmentItem({
    super.key,
    required this.item,
    required this.index,
  });
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              Get.to(AssessFormativePage(assessment: item));
            },
